...
- [ ] إضافة أداة create_customer للوكيل (إنشاء عميل جديد)
- [ ] إضافة أداة create_item للوكيل (إنشاء صنف جديد)
- [ ] تحديث System Prompt: الوكيل يعالج النواقص تلقائياً (عميل/صنف غير موجود → ينشئه)
- [ ] إعادة تسمية النظام إلى Almoaser AI ERP في كل الواجهات
- [ ] إضافة شعار المعاصر (almoaser.com) في النظام
