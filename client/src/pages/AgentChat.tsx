...
function humanChatError(err: unknown): string {
  ...
  if (isNetwork || !raw) {
    return navigator.onLine === false
      ...
      // لا نَعِد بعدم الخصم: النقاط تُخصم في أول المعالجة قبل استدعاء الموديل،
      // فالطلب الذي وصل الخادم ثم انقطع قد يكون خُصم فعلاً. وعدٌ بردّ لا نضمنه
      // أسوأ من صمت عنه.
      : "انقطع الاتصال قبل أن يكتمل الرد — أعد إرسال رسالتك من فضلك.";
  }
  return raw;
}
