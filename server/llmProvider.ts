 ...
 *
 * **خمسٌ وعشرون لا ستّون.** المهلة ليست «متى نيأس» بل «متى نجرّب غيره»:
 * الموديل الأوّل حين يتلكّأ يحبس الطلب وحده، وستّون ثانية تعني أن العميل
 * ينتظر دقيقةً قبل أن تبدأ المحاولة الثانية أصلاً. وقياسُ سارة على أسئلة
 * حقيقية: أربعة أسئلة أبطؤها اثنتان وثلاثون ثانية، وأسرعها عشر — فالنداء
 * الناجح لا يقترب من خمسٍ وعشرين، ومن تجاوزها فقد تعثّر لا أبطأ.
 */
const MODEL_TIMEOUT_MS = Number(process.env.LLM_TIMEOUT_MS ?? 25_000);

// **الأسرع أوّلاً، والأكبر بعده.** قِيس على أربعة أسئلة حقيقية من نظام عميل:
// 47.8ث بالسريع أوّلاً مقابل 67.6ث بالكبير، وكلفةُ النداء $0.00278 مقابل
// $0.00596. والأهمّ أن الجودة لم تنزل بل ارتفعت: سُئل عن الفواتير غير
// المدفوعة فقال الكبير «لا توجد» وقال السريع «لا شيء بوضع Unpaid، لكن أربعُ
// فواتير متأخّرة» — وهي موجودة فعلاً. جوابٌ أسرع وأرخص وأصحّ.
//
// والكبير يبقى في السلسلة لِما يتعثّر فيه الأوّل.
